/*
* CascadingDropDown : a jQuery plugin, version: 0.1 (2010-05-19)
...
*/
(function($) {
    $.fn.CascadingDropDownLiu = function(source, actionPath, settings) {
        ...
        var config = $.extend({}, $.fn.CascadingDropDownLiu.defaults, settings);
                ...
                var methods = {
                    ...
                    post: function() {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            dataType: 'json',
                            data: config.postData || $(source).serialize(),
    ...
    $.fn.CascadingDropDownLiu.defaults = {
        promptText: '-- Select --',
        loadingText: '加载中 ..',
