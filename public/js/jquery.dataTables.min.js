...
sInfo:"显示的是从第 _START_ 条记录到第 _END_ 条记录，一共  _TOTAL_ 条记录",sInfoEmpty:"显示的是从第 0 条记录到第 0 条记录，一共  0 条记录",sInfoFiltered:"(从 _MAX_ 条记录中过滤)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"每页显示 _MENU_ 条记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"从结果中查找:",sUrl:"",sZeroRecords:"没有找到任何结果"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",
